...
// You should make a different class to connecet to the database 
// And a different class for the chat model 

// Again USE DRY CODE (Dont Repeat Yourself!)

// You need to add comments in your code you it is easy to debug !
...
class chat{
	...
	public function insertUserLoginDetails($userId) {		
		$sqlInsert = " INSERT INTO ".$this->chatLoginDetailsTable." (userid) 
			VALUES ('".$userId."')";
		$results = mysqli_query($this->dbConnect, $sqlInsert);
		if(!$results){
